...
//step 1 order service produces a msg and sends it to rabbitMQ.
//step 2 rabbit mq exchange routes it to ORDER queue.
//step 3 notification serv consumes msg from ORDER queue, and once msg is received, it sends notfication to the customer.
@Configuration
class RabbitMQConfig {
	//getting queue and exchange names from properties file
    ...
    //generates a rabbit template used by order serv to produce msgs.
    @Bean
