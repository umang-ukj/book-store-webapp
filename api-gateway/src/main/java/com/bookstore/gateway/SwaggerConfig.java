...
// shows swagger docs for all the micro-services here itself, instead of configuring all one by one
@Configuration
class SwaggerConfig {
	//Provides all routes defined in Gateway
